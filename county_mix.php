...
<nav class="navbar" role="navigation" aria-label="main navigation">
  <div class="navbar-brand">
    <a class="navbar-item" href="county_mix.php">
      <img src="images/seal.png" max-width: 100%; max-height: 100%;>
    </a>
			  ...
			  <td>
                <?php
                  if(!empty($getData[2])){
                    ...
                    <img width="5%" height="30%" src="images/jubilee_Party.png">
                    <?php }elseif ($getData[2]=="KANU"){ ?>
                    <img width="5%" height="30%" src="images/KANU_party.jpg">
                    <?php }elseif ($getData[2]=="WDM K"||$getData[2]=="WDM K."){ ?>
                    <img width="5%" height="30%" src="images/wdmk_party.png">
                    <?php } elseif ($getData[2]=="CCM"){ ?>
                    <img width="5%" height="30%" src="images/CCM_party.png">
                    <?php } elseif ($getData[2]=="FORD Kenya"){ ?>
                    <img width="5%" height="30%" src="images/FORD_party.jpg">
                    <?php } elseif ($getData[2]=="Narc Kenya"){ ?>
                    <img width="5%" height="30%" src="images/NARC_party.jpeg">
                    <?php }
                        }
                    else {
